                    ...
                    <div className="col-6 menu">
                        ...
                        <div ref={ref} className={`menu__mobile ` + (burgerClicked ? 'show' : 'hide')}>
                            <ul>
                                ...
                                <li><a href="#">Afloat Collection</a></li>
                                <li><a href="#">for merchants</a></li>
                                <li><button className="primary-btn shop__now-btn">Shop Now</button></li>
                            </ul>
                        </div>

                        <div className={`menu__mobile-icons ` + (isDesktopSize ? 'show' : 'hide')}>
                            <button className={`menu__hamburger ` + (burgerClicked ? 'hide' : 'show')} onClick={() => setBurgerClicked(true)}><svg viewBox="0 0 100 80" width="30" height="30"><rect width="100" height="10"></rect><rect y="30" width="100" height="10"></rect><rect y="60" width="100" height="10"></rect></svg></button>
