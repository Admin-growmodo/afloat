...
function Header({ triggerSidebar }) {
    ...
    /* Upon loading the page the sign up modal always shows up. Integrate with check if user is logged in and already subscribed and sessions check if any.*/
    const [showNewsLetterSignUp, setShowNewsLetterSignUp] = useState(true);

    const [emailReset, setEmailReset] = useState('');

    const closeNewsLetterSignUp = () => {setShowNewsLetterSignUp(false)}
        ...
        <>
           ...
           <ResetEmailSent
            ...
            <NewsLetterSignUp 
                ...
                onCloseButtonClick={closeNewsLetterSignUp}
            />
